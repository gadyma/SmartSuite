...
try:
    from SmartsuiteConfig import TOKEN, ACCOUNT_ID,DEST_FOLDER
...
# Create a SmartsuiteConfig.py file and put in it the TOKEN &  ACCOUNT_ID
...
def download_attachment(url, file_path):
    ...
    if response.status_code != 200:
        ...
        with open(file_path, 'wb') as f:
            ...
            print(f"downloaded attachment {url} to {file_path}")
